...
func (c *userClient) Get(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (*GetUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/svc.User/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) GetAll(ctx context.Context, in *GetAllUsersRequest, opts ...grpc.CallOption) (*GetAllUsersResponse, error) {
	out := new(GetAllUsersResponse)
	err := c.cc.Invoke(ctx, "/svc.User/GetAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/svc/user_api.proto",
}
